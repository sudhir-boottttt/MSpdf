...
const STORAGE_KEY = 'MSpdf:wasm-providers';

const CDN_DEFAULTS: Record<WasmPackage, string> = {
  pymupdf: 'https://cdn.jsdelivr.net/npm/@MSpdf/pymupdf-wasm@0.11.14/',
  ghostscript: 'https://cdn.jsdelivr.net/npm/@MSpdf/gs-wasm/assets/',
