/*
 * coherentpdf.global.d.ts — TypeScript type definitions for MSPDF / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the MSPDF project.
