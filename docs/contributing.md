...
Thank you for your interest in contributing to MSPDF! This guide will help you get started.
...
git clone https://github.com/YOUR_USERNAME/MSpdf.git
cd MSpdf
...
See [TRANSLATION.md](https://github.com/alam00000/MSpdf/blob/main/TRANSLATION.md) for adding new languages.

## Contributor License Agreement

Before your PR can be merged, you'll need to sign our CLA:

- [Individual CLA (ICLA)](https://github.com/alam00000/MSpdf/blob/main/ICLA.md)
- [Corporate CLA (CCLA)](https://github.com/alam00000/MSpdf/blob/main/CCLA.md)

## Getting Help

- [GitHub Issues](https://github.com/alam00000/MSpdf/issues)
- [Discord Community](https://discord.gg/Bgq3Ay3f2w)

## License

MSPDF is dual-licensed:
